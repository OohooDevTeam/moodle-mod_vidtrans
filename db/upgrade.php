...
/**
 * Execute vidtrans upgrade from the given old version
 *
 * @param int $oldversion
 * @return bool
 */
function xmldb_vidtrans_upgrade($oldversion) {
    global $DB;
    ...
    if ($oldversion < 2007040100) {
        ...
        // Define field course to be added to vidtrans
        ...
        upgrade_mod_savepoint(true, 2007040100, 'vidtrans');
    }
    ...
    if ($oldversion < 2007040101) {
        ...
        // Define index course (not unique) to be added to vidtrans
        $table = new xmldb_table('vidtrans');
        ...
        upgrade_mod_savepoint(true, 2007040101, 'vidtrans');
    }
    ...
    if ($oldversion < 2007040200) {
        ...
        upgrade_mod_savepoint(true, 2007040200, 'vidtrans');
    }
